...
signal zero, jump, branch, regDst, regWr, memWr, memToReg, ALUSrc, co, ov, extOp, extSig : std_logic;
...
begin
	ins1: Instruction port map(zero=>zero, clk=>clk, jump=>jump, branch=>branch, reset=>reset, instruction=>ins);
